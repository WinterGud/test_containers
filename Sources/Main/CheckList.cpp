...
CheckList::CheckList(unsigned long long n)
    : NUM_TO_TEST(n)
{
}

void CheckList::checkPushBack()
{
    doContainerEmpty();
...
void CheckList::checkPushInMiddle()
{
    std::cout << "in process\n";
    // doContainerEmpty();
    // steady_clock::time_point timeStart = steady_clock::now();
...
void CheckList::doContainerEmpty()
{
    if(m_arr.empty())
    {
        return;
